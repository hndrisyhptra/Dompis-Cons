    ...
    <div class="px-4 mt-6">
        ...
        <div class="grid grid-cols-2 gap-3">
            <a href="{{ route('waspang.inbox') }}" class="bg-white rounded-2xl border border-slate-100 p-4 shadow-xs hover:border-blue-200 transition active:scale-[0.98]">
                ...
                <h3 class="font-black text-slate-800 text-sm">Inbox LOP</h3>
                <p class="text-[11px] text-slate-400 font-bold mt-0.5">
                    {{ $activeProjectsCount }} Project Aktif
                </p>
            </a>

            <a href="{{ route('waspang.ready-ut') }}" class="bg-blue-700 rounded-2xl p-4 text-white shadow-md hover:bg-blue-900 transition active:scale-[0.98]">
                ...
                <p class="text-[11px] text-emerald-400 font-bold mt-0.5">
        ...
        <div class="bg-white rounded-3xl border border-slate-100 p-5 shadow-xs">
            <div class="flex items-start justify-between mb-4">
                <div>
                    ...
                    <p class="text-base font-black text-slate-800 tracking-tight mt-0.5">
            ...
            <div class="w-full h-2.5 bg-slate-100 rounded-full overflow-hidden">
                {{-- Menggunakan bg-blue-600 untuk warna biru murni yang solid --}}
