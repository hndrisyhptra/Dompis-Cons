        ...
        <form method="GET" action="{{ route('waspang.ready-ut') }}">
            ...
            <div class="relative">
                ...
                <input type="text"
                    ...
                    class="w-full h-11 rounded-2xl border border-gray-300 bg-white pl-10 pr-4 text-sm font-medium focus:ring-2 focus:ring-green-100 focus:border-green-700 outline-none">
    ...
    <div class="px-4 mt-4 space-y-4">
        ...
        @empty
            ...
            <div class="bg-white border border-gray-200 rounded-2xl p-6 text-center text-gray-500">
                Belum ada LOP dengan status Finish.
            </div>
