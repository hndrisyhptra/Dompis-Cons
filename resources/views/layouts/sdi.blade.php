...
<div class="min-h-screen flex">
    ...
    {{-- Desktop Sidebar Khusus SDI --}}
    @include('sdi.components.sidebar')
    ...
    {{-- Mobile Sidebar Khusus SDI --}}
    <div x-show="sidebarOpen"
         x-transition
         class="fixed inset-y-0 left-0 z-50 w-64 lg:hidden">
        @include('sdi.components.sidebar-mobile')
    </div>
