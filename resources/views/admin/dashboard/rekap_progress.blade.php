            ...
            <div class="space-y-1.5">
                ...
                <div class="relative">
                    <select name="region" id="regionSelect" onchange="updateBranchDropdown(); document.getElementById('filterForm').submit();"
                            class="w-full h-11 pl-4 pr-10 appearance-none rounded-lg bg-gray-50 dark:bg-gray-950/40 border border-gray-200 dark:border-gray-800 text-sm font-medium text-gray-800 dark:text-gray-200 focus:bg-white focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all cursor-pointer">
            ...
            @if(request('program') || request('branch') || request('region') || request('status') || request('per_page'))
                <div>
                    <a href="{{ route('admin.rekap_progress') }}" 
                       class="inline-flex items-center justify-center h-11 px-5 rounded-lg border border-dashed border-gray-300 dark:border-gray-700 text-xs font-semibold text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-950/30 transition-colors w-full sm:w-auto">
...
<section class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 mb-8">
    ...
    <div class="bg-white dark:bg-gray-900 p-5 rounded-2xl border border-gray-200/80 dark:border-gray-800/80 shadow-xs flex items-center gap-4">
        <div class="w-12 h-12 bg-blue-50 dark:bg-blue-950/40 text-blue-600 dark:text-blue-400 rounded-lg flex items-center justify-center text-lg shadow-xs shrink-0">
    ...
    <div class="bg-white dark:bg-gray-900 p-5 rounded-2xl border border-gray-200/80 dark:border-gray-800/80 shadow-xs flex items-center gap-4">
        <div class="w-12 h-12 bg-indigo-50 dark:bg-indigo-950/40 text-indigo-600 dark:text-indigo-400 rounded-lg flex items-center justify-center text-lg shadow-xs shrink-0">
    ...
    <div class="bg-white dark:bg-gray-900 p-5 rounded-2xl border border-gray-200/80 dark:border-gray-800/80 shadow-xs flex items-center gap-4">
        <div class="w-12 h-12 bg-amber-500 text-white rounded-lg flex items-center justify-center text-lg shadow-xs shrink-0">
    ...
    <div class="bg-white dark:bg-gray-900 p-5 rounded-2xl border border-gray-200/80 dark:border-gray-800/80 shadow-xs flex items-center gap-4">
        <div class="w-12 h-12 bg-green-500 text-white rounded-lg flex items-center justify-center text-lg shadow-xs shrink-0">
                    ...
                    <tr class="hover:bg-gray-50/70 dark:hover:bg-gray-950/40 transition-colors">
                        ...
                        <td class="p-3.5">
                            <div class="space-y-1">
                                ...
                                <div class="w-full bg-gray-100 dark:bg-gray-800 h-1.5 rounded-lg overflow-hidden">
                                    <div class="bg-amber-500 h-full rounded-lg transition-all duration-500" style="width: {{ min($row['kabel_persen'], 100) }}%"></div>
                                </div>
                            </div>
                        </td>
                        ...
                        <td class="p-3.5">
                            <div class="space-y-1">
                                ...
                                <div class="w-full bg-gray-100 dark:bg-gray-800 h-1.5 rounded-lg overflow-hidden">
                                    <div class="bg-green-500 h-full rounded-lg transition-all duration-500" style="width: {{ min($row['tiang_persen'], 100) }}%"></div>
                                </div>
                            </div>
                        </td>
                    </tr>
    ...
    <div class="flex flex-col gap-6">
        ...
        <div class="bg-white dark:bg-gray-900 rounded-2xl border border-gray-200/80 dark:border-gray-800/80 p-5 shadow-xs">
            <div class="flex justify-between items-center mb-4">
                ...
                @if(request('program') || request('branch'))
                    <span class="relative flex h-3 w-3">
                      <span class="animate-ping absolute inline-flex h-full w-full rounded-lg bg-blue-400 opacity-75"></span>
                      <span class="relative inline-flex rounded-lg h-3 w-3 bg-blue-500"></span>
                    </span>
                @endif
            </div>
            ...
            <div class="grid grid-cols-2 gap-3">
                ...
                <div class="col-span-2 bg-blue-50/50 dark:bg-blue-900/20 p-3 rounded-lg border border-blue-100 dark:border-blue-800/30 flex justify-between items-center mb-1">
                ...
                {{-- Box Plan FO (Dinamis) --}}
                <div class="bg-gray-50 dark:bg-gray-950/50 p-3 rounded-lg border border-gray-100 dark:border-gray-800/50">
                ...
                <div class="bg-amber-50/30 dark:bg-amber-950/20 p-3 rounded-lg border border-amber-100 dark:border-amber-900/30 relative overflow-hidden">
                ...
                <div class="bg-green-50/30 dark:bg-green-950/20 p-3 rounded-lg border border-green-100 dark:border-green-900/30 relative overflow-hidden">
        ...
        <div class="bg-white dark:bg-gray-900 rounded-2xl border border-gray-200/80 dark:border-gray-800/80 p-5 shadow-xs">
            ...
            <div class="text-xs space-y-2.5">
                <div class="flex justify-between items-center bg-gray-50 dark:bg-gray-950/50 p-2.5 rounded-lg border border-gray-100 dark:border-gray-800/40">
...
<div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
    ...
    <div class="bg-white dark:bg-gray-900 p-5 rounded-2xl border border-gray-200/80 dark:border-gray-800/80 flex flex-col items-center justify-center shadow-xs">
        ...
        <p class="text-[11px] text-gray-500 font-mono mt-3 bg-gray-50 dark:bg-gray-950 px-3 py-1 rounded-lg border border-gray-100 dark:border-gray-800/60">
