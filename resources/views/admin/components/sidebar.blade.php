<aside class="hidden lg:flex lg:flex-col w-64 bg-white dark:bg-gray-900 border-r border-gray-200 dark:border-gray-800 min-h-screen">
                    ...
                    <a href="{{ route('approval-center.index', ['scope' => 'mine']) }}"
                       ...
                       {{ request()->routeIs('approval-center.*') && request('scope', 'mine') === 'mine' ? 'bg-slate-100 text-slate-950 dark:bg-slate-800 dark:text-white' : 'text-gray-600 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-800' }}">
                        ...
                        @if(($adminApprovalInboxCount ?? 0) > 0)
                            <span class="rounded bg-red-600 px-2 py-0.5 text-[10px] font-black text-white dark:bg-slate-200 dark:text-slate-900">{{ $adminApprovalInboxCount > 99 ? '99+' : $adminApprovalInboxCount }}</span>
                        @endif
                    </a>
                @endif
        ...
        <div x-data="{ open: {{ $projectOpen ? 'true' : 'false' }} }">
            ...
            <div x-show="open"
                ...
                {{ request()->routeIs('program.hem') ? 'bg-amber-50 text-amber-700 dark:bg-amber-950 dark:text-amber-300' : 'text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800' }}">
                    ...
                    <span class="text-[10px] px-2 py-0.5 rounded-lg bg-amber-100 text-amber-700">HEM</span>
                </a>
                ...
                {{ request()->routeIs('program.konstruk') ? 'bg-red-50 text-red-700 dark:bg-red-950 dark:text-red-300' : 'text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800' }}">
                    ...
                    <span class="text-[10px] px-2 py-0.5 rounded-lg bg-red-100 text-red-700">Exbis</span>
                </a>
    ...
    <div class="p-4 border-t border-gray-200 dark:border-gray-800">
        <div class="flex items-center gap-3 px-3 py-2 rounded-lg bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700">
            <div class="w-2 h-2 rounded-lg bg-green-500 animate-pulse shrink-0"></div>
