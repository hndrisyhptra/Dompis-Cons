...
<div class="space-y-6">
    ...
    @include('partials.report-deployment-tabs', [
        ...
        'reportRouteName' => 'admin.report_deployment',
    ])
    ...
    @else
        ...
        @include('partials.report-deployment-pt2', ['pt2StageCube' => $pt2StageCube, 'matrixDetailRoute' => 'admin.dashboard.matrix-detail'])
    @endif
</div>
@endsection
