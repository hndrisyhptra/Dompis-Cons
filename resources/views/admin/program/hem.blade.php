...
<div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-6">
    ...
    <!-- <div class="flex gap-2">
        ...
        <button type="button" onclick="openProjectModal('HEM')" class="h-10 px-4 inline-flex items-center justify-center rounded-lg bg-blue-600 hover:bg-blue-700 text-white text-sm font-semibold">+ LOP HEM Baru</button>
    </div> -->
</div>
...
<div class="bg-white dark:bg-gray-900 rounded-lg border border-gray-200 dark:border-gray-800 p-4 mb-6 shadow-sm">
    <form method="GET" action="{{ route('program.hem') }}" class="space-y-4">
        <div class="flex flex-col lg:flex-row gap-3">
            ...
            <a href="{{ route('program.hem') }}" class="h-11 px-5 inline-flex items-center justify-center rounded-lg border border-gray-300 text-sm font-bold hover:bg-gray-100">Reset</a>
        </div>
