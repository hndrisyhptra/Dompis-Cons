...
<div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-6">
    <div>
        ...
        <p class="text-sm text-gray-500 dark:text-gray-400">List Project Konstruksi Partner</p>
    </div>
    <!-- <div class="flex gap-2">
        ...
        <button type="button" onclick="openProjectModal('OLO')" class="h-10 px-4 inline-flex items-center justify-center rounded-xl bg-blue-600 hover:bg-blue-700 text-white text-sm font-semibold">+ LOP OLO Baru</button>
    </div> -->
</div>
...
@include('admin.program.partials.table', ['projects' => $projects, 'programName' => 'OLO'])
