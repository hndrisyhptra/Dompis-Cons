<aside class="hidden lg:flex lg:flex-col w-64 bg-white dark:bg-gray-900 border-r border-gray-200 dark:border-gray-800 min-h-screen">
    ...
    <nav class="flex-1 p-4 space-y-1">
        ...
        <div x-data="{ open: {{ $projectOpen ? 'true' : 'false' }} }">
            ...
            <div x-show="open"
                ...
                {{-- Menu "Konstruksi Eksternal" sengaja TIDAK ADA di sidebar
                     role super_tif (file ini khusus super_tif). Untuk
                     menampilkan/menyembunyikan menu lain untuk role ini,
                     cukup tambah/hapus langsung di file ini. --}}
        ...
        {{-- User Management sengaja TIDAK ADA di sidebar role super_tif. --}}
    ...
    <div class="p-4 border-t border-gray-200 dark:border-gray-800">
        <div class="flex items-center gap-3 px-3 py-2 rounded-xl bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700">
            ...
            <span class="text-xs font-bold text-gray-600 dark:text-gray-400">Super TIF Access Active</span>
        </div>
    </div>
