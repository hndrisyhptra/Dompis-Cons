...
@if(auth()->user() && auth()->user()->role === 'waspang')

    {{-- User Waspang: pakai bottom-nav yang sama persis dengan tampilan Waspang,
         supaya dari dalam fitur Survey tetap bisa langsung pindah ke Home / Inbox /
         Notif / Profil Waspang tanpa harus keluar/back berkali-kali. --}}
    @include('waspang.partials.bottom-nav', ['active' => 'survey'])
