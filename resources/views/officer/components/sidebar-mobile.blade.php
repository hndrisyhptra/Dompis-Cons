<aside class="flex flex-col w-64 h-screen max-h-screen bg-white dark:bg-gray-900 border-r border-gray-200 dark:border-gray-800 overflow-hidden">
    ...
    {{--
        Versi mobile dari resources/views/officer/components/sidebar.blade.php
        -- lihat file itu untuk catatan lengkap kenapa officer punya file
        sidebar sendiri (bukan reuse punya admin).
    --}}
    ...
    <div class="flex-1 min-h-0 overflow-y-auto overflow-x-hidden overscroll-contain p-4 space-y-1">
       ...
       {{-- PROJECT ID --}}
        ...
        {{--
            ...
            dihapus dari sidebar mobile officer (permintaan user).
        --}}
        ...
        {{--
            NOTE: Menu "Approval Eviden" SENGAJA dihapus dari sidebar mobile
            officer (permintaan user).
        --}}
        ...
        {{-- User Management: menu BARU khusus officer, selalu tampil di file
             ini (pembatasan aksi sepenuhnya dijaga di
