<aside class="hidden lg:flex lg:flex-col w-64 bg-white dark:bg-gray-900 border-r border-gray-200 dark:border-gray-800 min-h-screen">
    ...
    <nav class="flex-1 p-4 space-y-1">
        ...
        {{-- PROJECT ID (menu baru, menu & program sama seperti Admin --
             kecuali Konstruksi Eksternal yang disembunyikan untuk role tif,
             sama seperti pola yang sudah dipakai di dropdown Rekap Progress
             di bawah). Beda dengan Rekap Progress (matriks progres per
             region/branch), menu ini menampilkan daftar project satuan
             dengan tombol Detail Project & Tracking Progress -- lihat
             resources/views/pm/program/*.blade.php. --}}
        @php
        ...
        {{-- Report Deployment lengkap untuk PM dan TIF. --}}
